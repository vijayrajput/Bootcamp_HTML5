sap.ui.define([
		...
		opaTest("MasterList Filtering on RemainingTime less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("RemainingTime").
				and.iSelectListItemInViewSettingsDialog("<100 RemainingTimeUnit").
		...
		opaTest("MasterList Filtering on RemainingTime more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 RemainingTimeUnit").
				and.iPressOKInViewSelectionDialog();
